...
candidate completes the full public format check in `32.67 s` and all `22/22`
checks pass. This is comfortably below the earlier 37--40 second paired runs;
the contest server remains the only authoritative source for score and runtime
ordering.
